      ...
      ******************************************************************
       ...
       MAIN-PROCEDURE.
        PERFORM drawMap
        DISPLAY gameMap
        ACCEPT ACPT-KEY TIMEOUT AFTER 10 with auto
        move null to secondCol(5,5)
       ...
       prepareMap.
         ...
         move address of glyphFloor to thirdCol(5,5)
         move address of glyphFloor to thirdCol(6,6)
         move address of glyphFloor to thirdCol(7,7)
